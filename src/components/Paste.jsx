...
import { deletePasteThunk, fetchSolutions } from '../redux/pasteSlice';
...
const Paste = () => {
  ...
  // Fetch solutions from the backend when this page mounts
  useEffect(() => {
  ...
  // Client-side filter on title (Phase 6 will move this to the backend)
                ...
                >
                  ...
                  <div className="w-full sm:w-[50%] flex flex-col space-y-3">
                    ...
                    <p className="text-sm font-normal line-clamp-3 max-w-full sm:max-w-[80%] text-[#707070]">
                      {/* Show solution text as the preview (replaces old content field) */}
                      {paste?.solution}
                    </p>
                  </div>
